...
12. **Ders defteri:** her başarılı çemberden ve her beklenmedik hatadan çıkan ders **aynı çemberde** `PROJECT_STATE.md` → "Yapılmaması gerekenler" / "Karar günlüğü" bölümüne yazılır; kural niteliğindeyse `.claude/rules/`'a taşınır. Amaç: aynı hatayı iki kez yapmamak — hata lüksümüz yok, doğru hesaplama ve araştırma ile ilerlenir.
