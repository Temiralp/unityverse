(function () {
  ...
  function installStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = [
      '.', OVERVIEW_CLASS, '{max-width:1120px;margin:0 auto;padding:clamp(18px,3vw,36px);color:#2f3441;text-align:left;overflow-wrap:anywhere;}',
      '.', OVERVIEW_CLASS, ' *{box-sizing:border-box;max-width:100%;}',
      '.', OVERVIEW_CLASS, ' h1,.', OVERVIEW_CLASS, ' h2,.', OVERVIEW_CLASS, ' h3,.', OVERVIEW_CLASS, ' h4,.', OVERVIEW_CLASS, ' h5,.', OVERVIEW_CLASS, ' h6{clear:both;max-width:860px;margin:clamp(26px,4vw,44px) auto 14px;color:#11145d;font-family:inherit;font-weight:700;line-height:1.3;text-align:left!important;}',
      '.', OVERVIEW_CLASS, ' h1:first-child,.', OVERVIEW_CLASS, ' h2:first-child,.', OVERVIEW_CLASS, ' h3:first-child{margin-top:0;}',
      '.', OVERVIEW_CLASS, ' h1{font-size:clamp(25px,3vw,34px);}',
      '.', OVERVIEW_CLASS, ' h2{font-size:clamp(22px,2.5vw,30px);}',
      '.', OVERVIEW_CLASS, ' h3{font-size:clamp(19px,2vw,24px);}',
      '.', OVERVIEW_CLASS, ' h4,.', OVERVIEW_CLASS, ' h5,.', OVERVIEW_CLASS, ' h6{font-size:clamp(17px,1.7vw,20px);}',
      '.', OVERVIEW_CLASS, ' p,.', OVERVIEW_CLASS, ' li{font-size:clamp(15px,1.4vw,17px);line-height:1.75;text-align:left!important;}',
      '.', OVERVIEW_CLASS, ' p{max-width:860px;margin:0 auto 16px;}',
      '.', OVERVIEW_CLASS, ' ul,.', OVERVIEW_CLASS, ' ol{max-width:860px;margin:12px auto 20px;padding-left:clamp(22px,4vw,36px);text-align:left!important;}',
      ...
      '.', OVERVIEW_CLASS, ' .uv-overview-image{display:block;float:none!important;width:auto!important;max-width:100%!important;height:auto!important;margin:22px auto;border-radius:12px;object-fit:contain;}',
  ...
  function normalizeImages(overview) {
    Array.prototype.forEach.call(overview.querySelectorAll('img'), function (image) {
      ...
      if (link && link.tagName === 'A') link.classList.add('uv-overview-image-link');
    });
  }
